...
// Dev
//if (pageURL == 'https://thematicprojects.local/' || pageURL.includes('#')) {

// Prod
if (pageURL == 'https://www.thematicprojects.com/' || pageURL.includes('#')) {
...
document.addEventListener(
  ...
  function () {
    ...
    const menu_links = document.querySelectorAll(".menu-item a");

    //// Select first a element in the menu
    var firstLink = document.querySelector(".menu-item a");
    //// Add active class to first a element in the menu (toggle method below might be better)
    //firstLink.classList.add("active");
    //// Toggle active class to first a element in the menu
